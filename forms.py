...
from wtforms import StringField, TextAreaField, SelectField, DateField, FloatField, IntegerField, PasswordField, BooleanField, HiddenField
...
class ModifyBookingForm(FlaskForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.room_category.choices = [(0, 'Keep Current Room')] + [
            (cat.id, f"{cat.name} - ${cat.base_price}/night") 
...
class RoomForm(FlaskForm):
    ...
    floor = IntegerField('Floor', validators=[DataRequired(), NumberRange(min=1, max=50)])
